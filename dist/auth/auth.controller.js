...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Connexion et obtention du JWT' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Récupérer son profil connecté' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Profil utilisateur', type: user_dto_1.UserResponseDto }),
